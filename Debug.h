...
namespace Debug
{
	...
	{
		static std::map<Event, std::string> event_string_lookup = {
		{ NOTE_OFF, "Note Off" },
		{ NOTE_ON, "Note On" },
	...
	namespace HeaderChunk
	{
		static std::map<uint16_t, std::string> format_descriptions = {

			{ 0, "Single track MIDI File." },
			{ 1, "One or more tracks, played continuously." },
			{ 2, "One or more tracks, played sequentially." }
